...
<head>
  ...
  <style>
    ...
    *::after {
    ...
    .sort-active {
      background: #e0e7ff !important; /* var(--blue-bg) equivalent */
        ...
        <div class="modal-body">
          ...
          <div class="form-row">
            ...
            <div class="form-group">
              ...
              <input type="number" id="ar-rate" placeholder="e.g. <?= htmlspecialchars($system_rate) ?>" min="0" step="0.01" value="<?= htmlspecialchars($system_rate) ?>">
            </div>
          </div>
